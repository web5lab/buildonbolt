...
import { z } from 'zod';
import { Loader2, Upload, HelpCircle , ShieldCloseIcon } from 'lucide-react';
...
export function SubmitTemplate({ onClose }: SubmitTemplateProps) {
  ...
  const onSubmit = async (data: TemplateFormData) => {
    ...
    try {
      ...
      console.log('Template submitted:', { ...data, previewImage });
      onClose();
    } catch (error) {
